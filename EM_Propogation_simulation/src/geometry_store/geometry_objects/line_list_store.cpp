...
void line_list_store::add_line(int& line_id, glm::vec2& line_startpt_loc, glm::vec2& line_endpt_loc, glm::vec3& line_color)
{
...
void line_list_store::set_buffer()
{
	...
	const unsigned int line_vertex_count = 5 * 2 * line_count;
